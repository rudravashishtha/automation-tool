    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[85vh] w-[min(90vw,640px)] overflow-hidden">
        <DialogHeader>
          ...
          <DialogDescription>
            Set up how this node sends messages to Discord using a webhook.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Paste the webhook URL from your Discord server. You can
                      create one from Server Settings → Integrations → Webhooks.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      The content be sent to the Discord Channel by Bot. Use{" "}
